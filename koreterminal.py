...
def run_kore_terminal():
    ...
    print(f"{CYAN}Up/Down arrows = History | ls, cd {RESET}\n")
    
    while True:
        try:
            # Clean prompt with proper \~
            ...
            try:
                ...
                print(f"{RED}[-] Invalid syntax (check quotes){RESET}")
                continue
            ...
            if not is_command_installed(main_tool):
...
def main():
    if len(sys.argv) == 1:
        ...
        print("Run: python3 koreterminal.py")
